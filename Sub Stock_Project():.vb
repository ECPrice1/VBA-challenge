...
WorksheetName = "alphabetical_testing_3.xlsm"

For Each ws In Worksheets

'From Census exercise
...
LR = ws.Cells(Rows.Count, 1).End(xlUp).Row
 ...
 'May need to edit where these are for final submission
...
For I = 2 To LR
    ...
    If ws.Cells(I + 1, 1).Value <> ws.Cells(I, 1) Then
        ...
        'This I instance is the first where the ticker_sym doesn't match and the last in the group
...
End Sub
 ...
 'some code sourced from credit charges exercise: counting feature and storing ticker symbol value
 
 'read to last row sourced from star counter
 
 'worksheet loop
 'https://support.microsoft.com/en-us/topic/macro-to-loop-through-all-worksheets-in-a-workbook-feef14e3-97cf-00e2-538b-5da40186e2b0

'xpert learning assistant for help with worksheet loop + Formatting percentage column + color formatting
